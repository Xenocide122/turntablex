...
// INTERFACE
	...
	function addPanels(){
		...
		$('#ttx-panels').sortable({beforeStop:onPanelStop,sort:onPanelMove,appendTo:document.body,revert:100,placeholder:'placeholder',tolerance:'intersect',scroll:false,handle:'.floating-panel-tab',start:function(event,ui){ var width = ui.helper.width(); $(this).find('.placeholder').width(width); },stop:onPanelReorder});
