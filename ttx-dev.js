...
// INTERFACE
	...
	function addPanels(){
	    ...
	    tabs.append($('<div class="ttx-minimize" style="position:absolute;line-height:30px;right:10px;top:0px;height:20px"><h2 class="ttx-controls-dock" style="font-size:22px;margin-right:5px;">▴</h2><h2 class="ttx-controls-minimize" style="font-size:20px">−</h2></div>'));
