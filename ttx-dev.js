...
// INTERFACE
	...
	function addPanels(){
	    ...
	    // fix up chat
	    var rightPanel = $('#right-panel').css({right:'auto',top:'',bottom:'',height:'100%',marginLeft:'5px',width:PANEL_WIDTH+'px',left:'auto',float:'left',position:'relative',display:'inline-block'}).addClass('ttx-panel');
