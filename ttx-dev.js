...
// INTERFACE
	...
	function addPanels(){
		...
		$('#ttx-panels').sortable({revert:100,placeholder:'placeholder',tolerance:'pointer',scroll:false,handle:'.floating-panel-tab',start:function(event,ui){ $(this).parent().find('.placeholder').width($(this).width()); }});
