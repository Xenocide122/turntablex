...
(function(){
	...
	// perform graphical manipulation
	    ...
	    $('.header .logo').after('<div id="ttx_logo" style="left:180px; top: 15px; width: 40px; height: 40px; position:absolute; background-size: 40px 40px; background-image:url(http://turntablex.com/images/turntableX.png);"/>');
