		...
		if ($element.hasClass('modalContainer') ){
			if (_laptopHijack == true){
				...
				laptop.before('<div style="width:100%; padding-bottom:10px">\
						<div><div style="display:inline-block; margin: 8px; width:80px">Name:</div><input style="width: 300px; height:10px; position:relative; top: 8px;" type="text" value=""/></div>\
						...
						<div><div style="display:inline-block; margin: 8px; width:80px">Speed:</div><div style="display: inline-block; width:300px; height: 10px;" id="ttxLaptopSpeed"/></div>\
						</div>');
