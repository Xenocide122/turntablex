			...
			if (_laptopHijack == true){
				...
				laptop.before('<div style="width:100%; padding-bottom:10px">\
						<div><div style="display:inline-block; padding: 10px; width:80px">Name:</div><input type="text" value=""/></div>\
					        ...
					        <div><div style="display:inline-block; style="padding: 10px; width:80px">Animation:</div><input name="ttxLaptopAnimation" style="padding-right:5px" type="radio" value="text"/>text<input name="ttxLaptopAnimation" type="radio" style="padding-left:10px; padding-right:5px" value="custom"/><span>custom</span></div>\
						</div>');
			}
		}
	}
