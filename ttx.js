...
(function(){
	...
	// perform graphical manipulation
	    ...
	    $('.header .logo').after('<div id="ttx_logo" style="left:190px; width: 40px; height: 40px; position:absolute;background-image:url(http://turntablex.com/images/turntableX.png);"/>');
